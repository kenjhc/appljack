...
const csvFileUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR3V2IkGlSzc-S1jWLKLqJ7fgALYua8C0dTJO13jayFYhUHEQ2P776aC2HV7H1B53-Kbf-WfZ7_2GX_/pub?gid=0&single=true&output=csv';
...
async function downloadCsvAndConvertToXml() {
  try {
    ...
    if (response.status === 200) {
      ...
      const xmlFilePath = '/chroot/home/appljack/appljack.com/html/feeddownloads/xmldl_toothio.xml';
